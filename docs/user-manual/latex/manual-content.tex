...
PBGC CaseworkBench 2.0 supports local case intake, evidence preservation, human review, and manifest export. It is built to preserve evidence lineage and separate automated suggestions from human approval.
...
The evidence review workspace is currently a synthetic preview area. It validates in memory and does not persist final production plan rules.
